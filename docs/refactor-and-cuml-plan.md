...
- [ ] Update Modal image with cuML deps
- [ ] Update compute_umap() to use backend
- [ ] Update _fit_knn_model() to use backend
- [ ] Pre-seed all layer caches to R2
- [ ] Benchmark and document speedups
- [ ] Add DIFFVIEWS_FORCE_CPU env var

### M7: Hybrid Architecture (Future)
- [ ] Split modal_app.py into CPU/GPU
- [ ] Implement remote GPU function calls
- [ ] Add cold start loading UX
